...
#		./out 1
GUI:
		g++ -o gui  GUI.cpp glslprogram.cpp loader.cpp SimpleAI.cpp -DGLEW_STATIC -lGL  -lGLU /usr/lib/libglut.so  -lm -lGLEW -lGLU -lm -lGL -lm -lpthread -ldl -ldrm -lXdamage -lXfixes -lX11-xcb -lxcb-glx -lxcb-dri2 -lXxf86vm -lXext -lX11 -lpthread -lxcb -lXau -lXdmcp -fpermissive -lalut -lopenal
